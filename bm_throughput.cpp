...
int main(int argc, char *argv[]) {
    ...
    int timeframe;
    int id;
    int counter = 0;        //variable to count the number of lock acquiritions
    ...
    #pragma omp parallel private(id) shared(lock, _continue) reduction(+:counter)
    {
    ...
    std::string filename("results/throughput.csv");
